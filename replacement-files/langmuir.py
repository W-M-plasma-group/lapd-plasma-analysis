...
def swept_probe_analysis(  # noqa: PLR0915
   ...
   (T_e, hot_fraction), _ = get_electron_temperature(
   ...
   (T_e, hot_fraction, fit), temperature_problem = get_electron_temperature(  # LEO REVISION: used to be T, h, f = get_
       exponential_section,
...
def get_plasma_potential(probe_characteristic, return_arg=False):
   ...
   current = probe_characteristic.current.to(u.A)
   bias = probe_characteristic.bias.to(u.V)
